...
get_feature_coefs(fit_lasso, model="treatment")

```

# Extracting feature importance (tree based models)

Feature importance can be only be extracted for tree based models (decision trees, random forests, or gradient boosted trees). 
