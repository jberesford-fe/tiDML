...
I use the 401k data from Chernozhukov et al. (2018) to replicate results from [name of paper]. Note I'm following the example given in the package documenation for the [DoubleML Package] GET LINK. 

The goal is to show that `tiDML` produces comparable results, with less code and a more interpretable output.
...
run_both <- function(seed, df, y, d, x, trees_grid = 1200, n_folds = 2L, n_rep = 1L) {
