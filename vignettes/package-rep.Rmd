...
wide <- reshape(
  res[, c("seed", "method", "theta", "se", "lwr", "upr")],
  idvar   = "seed",
  timevar = "method",
  direction = "wide"
)
...
out <- data.frame(
  theta_delta_pct = 100 * mean(wide$theta.tiDML   / wide$theta.DoubleML   - 1),
  se_delta_pct    = 100 * mean(wide$se.tiDML      / wide$se.DoubleML      - 1),
  lwr_delta_pct   = 100 * mean(wide$lwr.tiDML     / wide$lwr.DoubleML     - 1),
  upr_delta_pct   = 100 * mean(wide$upr.tiDML     / wide$upr.DoubleML     - 1)
)
