...
Because Elastic Net is a linear model, we can use `get_feature_coefs(fit_lasso, model="treatment")` or `get_feature_coefs(fit_lasso, model="outcome")` to inspect the coefficients of the selected features.
